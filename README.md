...
Sections enpower your users into website manager. Not only you give them the ablitity to change the text of the website but you also give them freedom to change the apparence of the pages: the number of blocks, their order, their images, their text....

By defining sections you help your user test, magange and deploy new pages faster.

As time goes you will have a growing number of section to provide scalable websites and build faster form a section catalogue.
...
- Fix section that will be editable by users but will not be to move around.
...
`image_picker`  | Add an image picker to the editor. <br> You can add a cropper to let your users resize their images. To do so, add `"height": "100", "width": "100"` to your settings to let user crop image bigger than 100x100 to any size with same aspect ratio.
...
To register your section's javascript to this event you can add your a new javascript file in assets/javascript/sections, then export it in sections/index.js, and finnaly add `theme.registerSection('hello_world', Section.HelloWorld);` to app.js

Then the event you can register are : load, unload, select, deselect, reorder, blockSelect, blockDeselect.

This way you can adapt you javascript to this changes.
